...
SECRET_KEY = 'django-insecure-a8lb@6i3ss#w0#*$jdpvwofd#vhn+uhf0@ynx+j7mox14vttvo'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DB_HOST'),  # Set the host if needed
...
CELERY_BEAT_SCHEDULE = {
    'task_name': {
        'task': 'my_app.tasks.scheduledIncrementModal', 
        'schedule': 10.0, 
    },
}
